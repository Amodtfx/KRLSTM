...
load_data = read_csv('data/csv/XETHZEUR_full.csv', header=0)
...
for k in range(1,307):
    ...
    model = load_model("models/ETH/test_2017_retrained_%d.h5" % (k-1))
...
#----------------------------------------- 
    ...
    for i in range(window):
        ...
        avg_diff_output_txt = open('txt/ETH_avg_diff.txt','a+')  
    ...
    test_rmse_output_txt = open('txt/ETH_RMSE_output.txt','a+')  
    ...
    trade_output_txt = open('txt/ETH_trade_output.txt','a+')
