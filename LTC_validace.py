...
load_data = read_csv('data/csv/XLTCZEUR_2017_full.csv', header=0)

#for k in range(1,306):
for k in range(1,307):
    ...
    model = load_model("models/LTC/test_2017_retrained_%d.h5" % (k-1))
...
#----------------------------------------- 
    ...
    for i in range(window):
        ...
        avg_diff_output_txt = open('txt/LTC/avg_diff.txt','a+')  
    ...
    test_rmse_output_txt = open('txt/LTC_RMSE_output.txt','a+')  
    ...
    trade_output_txt = open('txt/LTC_trade_output.txt','a+')
